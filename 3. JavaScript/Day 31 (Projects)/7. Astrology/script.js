...
const compliments = [
  ...
  "You’re unbelievably thoughtful.",
  "Your positivity is contagious.",
  "You have a great sense of humor.",
  "You’re stronger than you realize.",
  "Your ideas are always brilliant.",
  "You make the world a better place.",
  "You’re remarkably dependable.",
  "Your kindness leaves a mark.",
  "You learn things incredibly fast.",
  "You’re full of refreshing energy.",
  "You handle challenges gracefully.",
  "You’re a natural leader.",
  "You make people feel valued.",
  "Your personality is magnetic.",
  "You’re impressively hardworking.",
  "You’re easy to talk to and trust.",
...
form.addEventListener('submit', (e) => {
    ...
    const Compliment = Math.floor(Math.random()*31);
    const victimCard = Math.floor(Math.random()*20);
    const recommend = Math.floor(Math.random()*30);
    const predict = Math.floor(Math.random()*20);

    // const text = `Hi ${name} ${surname}, 
    ...
    const text = `Hi ${name} ${surname}, 
                ...
                ${victimCardCompliments[victimCard]}
