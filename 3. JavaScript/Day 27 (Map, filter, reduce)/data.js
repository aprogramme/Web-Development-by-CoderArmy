...
// const newProduct = products.filter((product) => product.price > 50).sort((a, b) => b.price - a.price); // chaining of methods --> descending order
...
// Behind the scene of map------------------
// products.mapping = function(modify) {
//     const ans = [];
//     for(let prod of this) {
//         ans.push(modify(prod));
//     }
//     return ans;
// }
// const newProduct = products.mapping((product) => ({name: product.name, price: product.price}));
// console.log(newProduct);

// filter + sort + map chaining-----
